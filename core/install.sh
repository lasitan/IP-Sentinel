...
mkdir -p "$TMP_PY"
PY_FILES="__init__.py config.py log_util.py tg_util.py agent_spawn.py task_lock.py network.py persona.py geo_probe.py maps_browser.py mod_google.py mod_trust.py mod_quality.py runner.py report.py webhook.py updater.py agent_daemon.py"
